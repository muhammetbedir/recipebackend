...
{
    public class GetPopularRecipesByPageHandler : IRequestHandler<GetPopularRecipesByPageQuery, List<GetAllRecipesDto>>
    {
        private readonly IRecipeRepository _recipeRepository;
        private readonly ICommentRepository _commentRepository;
        private readonly IMapper _mapper;

        public GetPopularRecipesByPageHandler(IRecipeRepository recipeRepository, IMapper mapper, ICommentRepository commentRepository)
        {
            _recipeRepository = recipeRepository;
            _mapper = mapper;
            _commentRepository = commentRepository;
        }
        public async Task<List<GetAllRecipesDto>> Handle(GetPopularRecipesByPageQuery request, CancellationToken cancellationToken)
        {
            var populerRecipes = await _recipeRepository.getPopularRecipesByPage(request);
